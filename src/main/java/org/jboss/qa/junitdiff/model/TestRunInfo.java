...
public class TestRunInfo {
	...
	public TestRunInfo(String classname, String name, Result result, String time) {
	...
	public void setGroup(IGroup group) {		this.group = group;	}
	public String getGroupID() {	return group.getId().toString();	}
	// </editor-fold>
